...
import ViewportPadding, { Breakpoint } from "@app/components/ViewportPadding";
            ...
            <div className="relative z-10 mt-auto flex translate-y-[10%] justify-center pt-16 md:pt-20 lg:-mt-11 lg:translate-y-0 lg:pt-0">
              <div className="max-w-[18rem] flex-grow md:max-w-[20rem] lg:block lg:max-w-[22rem]">
                <Image
                  ...
                  sizes={`(min-width: ${constants.screens.lg}) 22rem, (min-width: ${constants.screens.md}) 20rem, 18rem`}
                  src={rocket}
                  alt="rocket"
                  priority
                />
            ...
            <Container>
              <div className="flex flex-col items-center">
                <div className="mb-5 flex items-center justify-center rounded-full bg-gradient-to-r from-purple-500 to-pink-400 p-1">
                  <div className="h-16 w-16 rounded-full border-[3px] border-white lg:h-20 lg:w-20">
                    <Image
                      ...
                      sizes={`(min-width: ${constants.screens.lg}) 5rem, 4rem`}
                      src={avatar}
                ...
                <Paragraph className="text-center">
                  Specializing in frontend web development, I use JavaScript,
                  Node.js, TypeScript, HTML, CSS, and React to make websites and
                  apps focused on performance, accessibility, and a delightful
                  user experience.
                </Paragraph>
              </div>
                  ...
                  <div className="col-span-9 col-start-2 mb-20 flex justify-center pl-1">
                    <div className="max-w-xl text-center">
                      ...
                      <Paragraph color="lightGray">
                        ...
                        features for Wikipedia's desktop and mobile sites which
                        are used by millions of users every day across the world
                        in over 300 different languages.
                      </Paragraph>
                      <a
                  ...
                  <ul className="col-span-10 col-start-2 space-y-20 md:space-y-32">
                    {[
                      <TimelinePoint
                        ...
                        description={
                          <>
                            ...
                            that is used each week to catch UI bugs before users
                            see them and increase confidence in releases to
                            production.
                          </>
                        }
                        image={
                      ...
                      <TimelinePoint
                        ...
                        description={
                          <>
                            Improved the desktop search experience by developing
                            a new typeahead search component written in Vue.js
                            and TypeScript. Increased the component's robustness
                            by implementing synthetic test telemetry to
                            automatically measure the search component’s
                        ...
                        image={
                          <Image
                            ...
                            className="w-full"
                            sizes={`(min-width: ${constants.screens.md}) ${
                              545 / 16
                            }rem, 75vw`}
                            src={typeaheadImage}
                      ...
                      <TimelinePoint
                        ...
                        description={
                          <>
                            ...
                            DOM and featured an optimal line length for reading.
        ...
        <section id="blog" className="text-gray-700">
          <ViewportPadding>
            <Container>
              ...
              <Paragraph>
                I recently started a blog where I share what I’ve learned about
                JavaScript, CSS, and the rest of the frontend development world.
              </Paragraph>
