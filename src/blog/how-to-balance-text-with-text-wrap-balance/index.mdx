...
description:
  ...
  headlines."
seoTitle: "CSS Text Balance: How to Use text-wrap: balance"
seoDescription:
  "Use CSS text-wrap: balance to improve headline wrapping without JavaScript and avoid awkward single-word lines."
