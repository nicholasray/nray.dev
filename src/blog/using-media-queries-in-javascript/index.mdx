...
seoTitle: "Using Media Queries in JavaScript with matchMedia"
seoDescription:
  "Use JavaScript media queries with window.matchMedia, MediaQueryList change events, and responsive browser behavior."
