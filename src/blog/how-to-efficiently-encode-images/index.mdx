...
description:
  ...
  times."
seoTitle: "Efficiently Encode Images for PageSpeed and Lighthouse"
seoDescription:
  "Fix the Lighthouse Efficiently encode images warning with image compression, quality settings, and faster image delivery."
