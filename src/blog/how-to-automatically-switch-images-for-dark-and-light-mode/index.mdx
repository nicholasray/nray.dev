...
cover:
  src: ./_assets/dark-mode-image-switching-cover.jpg
  alt: Image switching to a dark mode version
description:
  Learn how to automatically display the correct image for dark and
  light mode on your website
...
<Aside heading="Lazy load images carefully">
  ...
  loading it. This ensures the image appears as quickly as possible
  and avoids negatively affecting your [Largest Contentful
