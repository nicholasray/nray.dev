...
seoTitle: "Astro vs. Next.js: Which Is Better for Static Sites?"
seoDescription:
  "Compare Astro and Next.js for static, content-heavy sites, including performance, JavaScript output, complexity, and developer experience."
