...
seoTitle: "Tailwind Dark Mode: Colors, Theme Toggle, and Meta Tags"
seoDescription:
  "Build Tailwind CSS dark mode with dark variants, color palettes, theme-color metadata, color-scheme metadata, and a theme toggle."
