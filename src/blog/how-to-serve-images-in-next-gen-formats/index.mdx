...
description:
  ...
  possible"
seoTitle: "Serve Images in Next-Gen Formats with WebP and AVIF"
seoDescription:
  "Fix the Lighthouse next-gen image formats audit by serving WebP or AVIF images and keeping fallbacks for browser support."
