...
The `dark:hidden` class hides the "Dark" label when dark mode is active and
instead show the "Light" label with the `dark:block` class.
...
You should now have a functional theme toggle that is persistent:
