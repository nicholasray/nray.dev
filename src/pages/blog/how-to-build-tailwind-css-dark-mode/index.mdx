...
This is usually undesirable from a performance perspective, but advantageous in
this case because we don't _want_ the browser to render anything until we know
which theme the website uses:
