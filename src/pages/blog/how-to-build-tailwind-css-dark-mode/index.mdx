...
frameworks. Nevertheless, the concepts presented in this article apply to many
...
Adding dark mode support is no different. Simply prefix any supported class name
with `dark:`, and that style will apply when the user has enabled their
