...
where you try to find slight differences between two very similar images? When I
review code in a nontrivial patch or pull request that changes a website's HTML,
CSS, or JavaScript, I'm playing this game. Sometimes I win. Other times, I lose.
...
- If you're a Wikimedia developer interested in using visual testing on your
  team, you might be interested in [Pixel](https://github.com/wikimedia/pixel)

- If you're interested in using visual testing outside of Wikimedia projects,
  you might be interested in [Playwright](https://playwright.dev/) or
