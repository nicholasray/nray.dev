...
Still, there are several difficulties we've experienced and drawbacks to our
approach:
...
captures 140 screenshots and tests five different viewport widths. We have
visual regressions that still slip into production. However, many of these
