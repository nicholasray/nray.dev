...
whenever I review code in a nontrivial pull request that changes a
website's HTML, CSS, or JavaScript. Sometimes I win. Other times, I lose.
...
visual changes a code change causes. And failing to spot these
differences can result in a degraded user experience, loss of
...
At that point, we built and released several features of our new skin,
...
Each feature we completed was coupled with a significant risk that it would deviate from its meticulous design spec as time passed. For example, one of
