...
<Video
  description="Video showing a failed visual test with a difference in spacing between the title of the article and the table of contents icon button as well as a difference in width of the table of contents. In the video, the user is able to see the reference image, test image, and the differences highlighted in pink between the two images."
  width="1818"
  height="1080"
  src={visualTestDemo}
/>
