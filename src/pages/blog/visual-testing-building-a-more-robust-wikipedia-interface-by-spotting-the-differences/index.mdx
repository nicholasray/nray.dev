...
loss of functionality, a significant amount of time spent fixing the issues, or
worse.
...
captures 140 screenshots and tests five different viewport widths. We definitely
still have visual regressions that slip into production. However, many of these
result from _not_ having the necessary visual tests in place for specific
