...
of harmless differences, there are times when it is difficult to determine the
number of visual changes a code change might cause. Additionally, failing to
