...
<Image
  src={complexStates}
  alt="A grid showing some of the different states that the table of contents, page tools, and main menu could have."
  caption="A grid showing some of the different states that the table of contents, page tools, and main menu could have."
/>
