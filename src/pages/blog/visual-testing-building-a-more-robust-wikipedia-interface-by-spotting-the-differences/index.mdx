...
whenever I review code in a nontrivial patch or pull request that changes a
...
visual changes a code change might cause. Additionally, failing to spot these
differences in code can result in a degraded user experience, loss of
