...
code you can either optimize or remove.
...
showed approximately a 200ms decrease in TBT after the first deployment and
about a 80ms reduction after the second deployment when testing on a Moto G (5)
