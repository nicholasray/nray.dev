...
600ms may not sound like a long time, but imagine if a user tried to click a
button during page load when the 600ms of JavaScript began executing. Because
JavaScript is single-threaded, the user would need to wait for the following
...
elements, especially when user-generated content could add many elements. It
takes advantage of
...
Still, the task was reduced by about 50% with a couple small wins.
