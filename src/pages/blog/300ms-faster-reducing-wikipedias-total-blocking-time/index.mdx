...
load. Because JavaScript is single-threaded, the user would need to wait for
this JavaScript to complete before the browser could execute the relevant click
handler and respond to that interaction with a visual update. And any
interaction that takes longer than
