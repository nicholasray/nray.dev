...
Have you ever experienced frustration while interacting with a website that was
slow to respond to your clicks or had jerky scrolling? Performance flaws like
...
execution time of this task by over 50%. Let's explore how even small changes
can make a substantial difference in delivering a smoother browsing experience."

## Long tasks: what's the big deal?
...
only one task can be processed on the browser's
...
1. The 600ms JavaScript task completes
2. The relevant click handler task completes
...
to be **slow**. Because of this, Google considers any task that takes
...
[Time to Interactive](https://web.dev/tti/). The "blocking portion" is the time
after 50ms of each long task.
...
2. The second task doesn't contribute to TBT since it is less than 50ms.
...
## Step 1: Do less work by removing JavaScript
...
Still, the task was reduced by about 50% with a couple of small wins.
