...
to be **slow**. Because of this, Google considers any task on the browser's
[main thread](https://developer.mozilla.org/en-US/docs/Glossary/Main_thread)
that takes
[over 50ms](https://web.dev/optimize-long-tasks/#what-is-the-main-thread) a
...
Worse yet, this behavior was unnecessary. The downstream code that listened to
the `hashchange` event already called the same method that the click event
