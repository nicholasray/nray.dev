...
<Image
  background
  src={profileRemoval}
  alt="Chrome performance profile showing that a `on` method took 264ms to execute and all of this code can be removed."
/>
...
<Image
  ...
  alt="Chrome performance profile showing that a `initMediaViewer` method took 114ms to execute."
/>
...
The work from step 1 and step 2 were released to production in two deploys with
step 1 deployed first followed by step 2.
