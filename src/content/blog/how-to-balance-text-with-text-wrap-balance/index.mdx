...
So you have headlines on your site that can wrap only one or two words to the
next line, looking uneven and **awkward**. They would look a lot better if they
were **balanced**.
...
I'm using it for the first heading of my articles — resize the window to see it
in action.
