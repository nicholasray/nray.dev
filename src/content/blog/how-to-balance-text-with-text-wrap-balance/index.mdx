...
<Image
  src={comparison}
  alt="A comparison of an unbalanced heading vs. balanced heading. The unbalanced heading has one word that awkwardly wraps to the next line, while the balanced text has two lines of text closer to the same width."
/>
