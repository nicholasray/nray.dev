...
including [**Medium**](/assets/deferred-offscreen-image/medium.webp),
...
- [WordPress 5.9+](https://make.wordpress.org/core/2021/12/29/enhanced-lazy-loading-performance-in-5-9/)
  ...
  image, which most of the time appears above the fold
...
- Serve the [best image format](/blog/how-to-serve-images-in-next-gen-formats/) for the fastest load times.
