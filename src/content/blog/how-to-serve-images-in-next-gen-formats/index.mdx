...
your website to see the potential file differences you might get from
...
- A
  ...
  WordPress will land in the core platform. For now, using a
...
- Prefer `<video>` elements over **animated GIFs**. Most of the time,
  videos will be significantly smaller.
