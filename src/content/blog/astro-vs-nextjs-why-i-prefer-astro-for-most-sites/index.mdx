---
title: "Astro vs. Next.js: Why I Prefer Astro For Most Sites"
cover:
  ...
  position: bottom
description:
  Why I prefer to use the Astro framework for static, content-heavy
  websites.
publishedAt: 2024-04-05
---

I've been using the [Astro framework](https://astro.build/) to create
websites (like this one) for a while, dating back to around its 1.0
release. During this time, I've also spent months experimenting with
the much more popular Next.js framework, which is used by companies
like Spotify, OpenAI, Nike, and more.
...
<Image
  src={blankPage}
  alt="Chrome Dev Tools Network Tab showing that it takes 87.5 KB of JavaScript to load blank page with Next.js, while it takes 0 KB with AstroJS."
  caption="Next.js loads 87.5 KB of JavaScript (after compression) on a blank white page. Astro loads zero JavaScript."
/>

Because of its client-side router and dependence on React.js (among
other things), Next.js will load a minimum of **87.5 KB** of
JavaScript (after compression) — _even if your page is blank_. How
much JavaScript does Astro load for that same page?
...
- By using client-side navigation, Next.js must re-implement
  ...
  that behavior**. Otherwise, a user who clicks a link on a slow
  ...
  and the browser already provide robust solutions?
- On a related note, relying on the browser to perform something as
  ...
  navigation. Meanwhile, browsers have spent decades perfecting the
...
<Aside heading="Can't I just use the standard anchor link in Next.js?">
  ...
  it. If you choose to do this, you will also lose out on the prefetching feature.
</Aside>
...
default. If you're creating a mostly static site, I think you should
definitely consider choosing it.
