...
Placing the MP4 `<source>` element on top of the WebM would cause
browsers that support both formats to use MP4. It's important to put
the lightest format on top.
...
## Step 4: Add aspect ratio

- Using width and height attributes
  [doesn't work](https://github.com/w3c/csswg-drafts/issues/7524) for
  videos like it does for images
