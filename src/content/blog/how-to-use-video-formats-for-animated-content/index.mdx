...
In this example, there is only one animated GIF we're replacing, and
it's
[above the fold](/blog/how-to-defer-offscreen-images/#what-are-lazy-loaded-images).
But
[similar to offscreen images](/blog/how-to-defer-offscreen-images/#why-cant-i-load-all-my-images-during-page-load),
try to
