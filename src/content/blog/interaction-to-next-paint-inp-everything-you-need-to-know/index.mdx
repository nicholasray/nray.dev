...
Although a relatively new metric, improving INP has demonstrated to be important
for user happiness and business success:

- [redBus increased sales by 7%](https://web.dev/redbus-inp/)
...
## How is INP different than First Input Delay (FID)?

INP is expected to provide a more complete assessment of a user's experience on
a page compared to FID by:
...
- Measuring the time it takes from the start of the interaction to moment the
  first frame appears instead of the moment that event callbacks can start
  executing

The numbers back this up — as of May 2023,
[99.9% of desktop sites and 93.2% of mobile sites passed FID](https://httparchive.org/reports/chrome-ux-report#cruxFastFid)
with flying colors, compared to
[96.6% of desktop sites and 64.9% of mobile sites passing INP](https://httparchive.org/reports/chrome-ux-report#cruxFastInp).
