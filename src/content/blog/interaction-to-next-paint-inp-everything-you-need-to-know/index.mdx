...
Currently, **35.1% of mobile websites** fall short of Google's latest web
...
to the rendering tree and cause some delay, it is more efficient than rendering
_all_ the sections (unless the user toggles all sections). Wikipedia uses this
technique on its mobile site for most sections of an article.
