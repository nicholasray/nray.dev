...
<Image
  ...
  dark={inpSpinnerDark}
  fullWidth={false}
  alt="An interaction timeline showing the latency between a click, tap, or key press and a visual update consisting of a loading spinner."
...
to optimize it. Armed with actionable tips, you now have tools to improve your
INP score, ensuring your website is more responsive and enjoyable for everyone.
