...
the next best option is to **yield to the main thread**. **Split up the work**
into **smaller tasks** that each take less than **50 ms** to execute and
prioritize the work that is user-facing. The benefits of doing this are
two-fold:
