...
import lighthouseMessage from "./_assets/lighthouse-defer-offscreen-images-message.webp";
...
This is the technique used by some of the biggest sites in the world, including
[**Medium**](/assets/deferred-offscreen-image/medium.png),
[**LinkedIn**](/assets/deferred-offscreen-image/linkedin.png), and
[**IMDb**](/assets/deferred-offscreen-image/imdb.png). In this article, I'll
