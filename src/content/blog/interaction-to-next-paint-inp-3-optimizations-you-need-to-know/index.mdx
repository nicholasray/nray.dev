...
INP captures the elapsed time each interaction takes to produce a visual update
...
latency. Part of the reason why First Input Delay rarely had a failing result
was that it only measured the input delay portion of the user's first
interaction. Because INP measures all the way to the first frame a user can see,
it is much better indicator of a user's experience.
