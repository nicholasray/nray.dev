...
**March 2024**, replacing **First Input Delay (FID)** as the responsiveness
metric.
...
discrete units of work carried out by the browser, including rendering, layout,
and parsing and executing JavaScript.
